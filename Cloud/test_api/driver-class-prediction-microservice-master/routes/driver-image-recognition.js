...
var SpawnPython_1 = require("../services/SpawnPython");
...
*/
router.post('/:id(\\d{0,})', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, model_name, result;
    return __generator(this, function (_a) {
        id = req.params.id;
        model_name = "/home/ubuntu/Image_recogntion/mobilenet_0";
        //const model_name = "mobilenet_0";
        //debug(`image_id = ${id}`);
        try {
            result = SpawnPython_1.diverImageRecognitionByPython(id, model_name);
            //const p4 = moment();
            ...
            //debug('ERROR = ', e);
            //console.log(e)
            res.status(ERROR_1.ERROR.code500.code).send(e);
        }
        return [2 /*return*/];
    });
}); });
