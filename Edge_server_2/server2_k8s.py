...
def create_deployment_object(ml_type):
    ...
    #Container obj
    container = client.V1Container(name = ml_type, image=('sri2301/'+ ml_type +'test10'), ports=[client.V1ContainerPort(container_port=5700)],resources=res)
    #Pod obj
...
def service_request(): 
    ...
    service_port = {'scalar':'32760', 'image':'32762'}
    ...
    nsp = (ml_type+'-test')
    nm = (ml_type+'-deploy')
    #print("pull the new image = {}".format(datetime.now()))
    #pull_image = cli.images.pull('sri2301/'+ml_type+'test6')
    #print("pull completed = {}".format(datetime.now()))
    time.sleep(6)
    ...
    print("container creation time = {}".format(wait_time))
