...
def image_detection(image, network, class_names, class_colors, thresh):
    ...
    ml_st =time.time() #for check inference time -jh
    ...
    ml_exec = time.time()-ml_st #for check inference time -jh

    return image, detections, ml_exec
...
async def accept(websocket, path):
    ...
    while True:
        ...
        if len(data) != 0:
            ...
            prev_time = time.time()
            count = count + 1
            image, detections, ml_exec = image_detection(
                hg_image, network, class_names, class_colors, args.thresh
                )
            total_ml_exec = total_ml_exec + ml_exec
            print("--------------------- count & execution time average ---------------------------")
            print(count)
            print(str(total_ml_exec/count))
            print("--------------------------------------------------------------------------------")
