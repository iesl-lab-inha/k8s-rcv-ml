...
async def connect(s_frame):
    async with websockets.connect("ws://165.246.41.238:9998") as websocket:
    #async with websockets.connect("ws://165.246.41.45:30040") as websocket: #jh
...
def main():
    ...
    while True:
        ...
        try:
            ...
            #cv2.waitKey(1)
            asyncio.get_event_loop().run_until_complete(image_connect(EDGE_WS, num_port,s_frame)) #for edge -jh
