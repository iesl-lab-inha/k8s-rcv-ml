...
CENTER = 'http://ec2-18-119-162-53.us-east-2.compute.amazonaws.com'
#CENTER_WS = 'ws://172.31.7.139'
CENTER_WS = 'ws://18.119.162.53'
            ...
            while True:
                ...
                try:
                    ...
                    for i in range(0,40):
                        ...
                        print('**before send') 
                        #await websocket.send('a') #간단한 데이터 보내보기
